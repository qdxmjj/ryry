...
public class RequestUtils {
    ...
    public static String REQUEST_URL_TEST = "http://192.168.0.96:8060/";            //主页测试 鸟
    public static String REQUEST_URL_NIAO_TEST = "http://192.168.0.96:10008/";      //积分测试 鸟
    public static String REQUEST_URL__GONGLIN_TEST = "http://192.168.0.170:8060/";   //注册也是 龚
    public static String REQUEST_URL_RELEASE = "http://180.76.243.205:10002/xmjj-webservice/";


    public static String REQUEST_URL_GONGLIN_FAHUO_TEST = "http://192.168.0.170:8030/";//龚林 测试 发货
    ...
    public static String REQUEST_URL_FAHUO = REQUEST_URL_GONGLIN_FAHUO_TEST;     //发货
