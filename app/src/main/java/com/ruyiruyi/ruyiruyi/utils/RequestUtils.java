...
public class RequestUtils {
    ...
    public static String REQUEST_URL_TEST = "http://192.168.0.105:8060/";
    public static String REQUEST_URL_TEST_GL = "http://192.168.0.190:8060/";
    public static String REQUEST_URL_WAIWANG_TEST = "http://ruyiruyi.s1.natapp.cc/xmjj-webservice/";
    //http://192.168.0.105:8060/
    public static String REQUEST_URL = REQUEST_URL_TEST_GL;
}