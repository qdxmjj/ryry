...
public class GoodsVertical implements Serializable{
    ...
    public GoodsVertical(int goodsId, String goodsImage, String goodsName, String goodsPrice, int goodsAmount,int currentGoodsAmount,int goodsClassId,int serviceTypeId) {
