...
public class InviteBuyshoeActivity extends RyBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downDialog = new ProgressDialog(InviteBuyshoeActivity.this);
    ...
    private void initData() {
        ...
        try {
            object.put("userId", new DbConfig(InviteBuyshoeActivity.this).getId() + "");
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    money = Double.parseDouble(data.getString("totalReward"));
    ...
    private void showBottomShareMenu() {
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(InviteBuyshoeActivity.this);
        bottomSheetDialog.setCanceledOnTouchOutside(true);
        View contentView = LayoutInflater.from(InviteBuyshoeActivity.this).inflate(R.layout.bottomsheet_share, null, false);
        ...
        //设置底部白色背景为透明
        bottomSheetDialog.getDelegate().findViewById(android.support.design.R.id.design_bottom_sheet).setBackgroundColor(InviteBuyshoeActivity.this.getResources().getColor(R.color.transparent));
