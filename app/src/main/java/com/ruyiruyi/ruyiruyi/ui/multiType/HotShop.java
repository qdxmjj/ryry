...
public class HotShop implements Serializable {
    ...
    public HotShop(int storeId, String storeTypeName, String storeTypreColoe, String storeName, String storeImage, String storeAddress, String storeDistence) {
    ...
    public HotShop(int storeId, String storeTypeName, String storeTypreColoe, String storeName, String storeImage, String storeAddress, String storeDistence, List<ServiceType> serviceTypeList) {
        this.storeId = storeId;
        this.storeTypeName = storeTypeName;
        this.storeTypreColoe = storeTypreColoe;
        this.storeName = storeName;
