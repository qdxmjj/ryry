...
public class SearchView extends LinearLayout {
    ...
    private  ItemCallBack itemCallBack; // 返回按键回调接口
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int defaultColor = context.getResources().getColor(R.color.c5); // 默认颜色 = 灰色
     ...
     *item点击用于回调
     */
    public void setOnItemClickBack(ItemCallBack itemCallBack){
