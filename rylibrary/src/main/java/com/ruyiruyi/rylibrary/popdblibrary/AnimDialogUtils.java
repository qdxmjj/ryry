...
import com.ruyiruyi.rylibrary.popdblibrary.anim.AnimSpring;
...
public class AnimDialogUtils {
    ...
    public void show(int animType, double bounciness, double speed) {
        ...
        //设置点击边缘是否可关闭dialog以及点击监听事件的传递   bingo
        animBackView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (canOutClose) {
                    if (onOutCloseClickListener != null) {
                        onOutCloseClickListener.onClick(v);
                    }
     ...
     * @return
     */
    public AnimDialogUtils setDialogClickOutCloseable(boolean canOutClose) {
     ...
     * @return
     */
    public AnimDialogUtils setOnOutCloseClickListener(View.OnClickListener onOutCloseClickListener) {
