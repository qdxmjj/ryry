...
/*        ImageOptions myOptions = new ImageOptions.Builder()
    ...
    private void initView() {
        ...
        img_mdpic_a = (CircleImageView) getView().findViewById(R.id.img_mdpic_a);
        img_mdpic_b = (CircleImageView) getView().findViewById(R.id.img_mdpic_b);
        img_mdpic_c = (CircleImageView) getView().findViewById(R.id.img_mdpic_c);
