...
public class RegisterActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    private CircleImageView img_yyzz;
    private ImageView img_yyzz_delete;
    private CircleImageView img_mdpic_a;
    private ImageView img_mdpic_a_delete;
    private CircleImageView img_mdpic_b;
    private ImageView img_mdpic_b_delete;
    private CircleImageView img_mdpic_c;
    private ImageView img_mdpic_c_delete;
    private CircleImageView img_shou_a;
...
/*                }*/
        ...
        img_yyzz = (CircleImageView) findViewById(R.id.img_yyzz);
        img_yyzz_delete = (ImageView) findViewById(R.id.img_yyzz_delete);
        img_mdpic_a = (CircleImageView) findViewById(R.id.img_mdpic_a);
        img_mdpic_a_delete = (ImageView) findViewById(R.id.img_mdpic_a_delete);
        img_mdpic_b = (CircleImageView) findViewById(R.id.img_mdpic_b);
        img_mdpic_b_delete = (ImageView) findViewById(R.id.img_mdpic_b_delete);
        img_mdpic_c = (CircleImageView) findViewById(R.id.img_mdpic_c);
        img_mdpic_c_delete = (ImageView) findViewById(R.id.img_mdpic_c_delete);
        img_shou_a = (CircleImageView) findViewById(R.id.img_shou_a);
