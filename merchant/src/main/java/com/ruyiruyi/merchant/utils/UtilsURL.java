...
public class UtilsURL {
    public static final String LOGIN_PASS_REQUEST_URL_BIRD_SERVER = "http://192.168.0.94:8060/";//鸟
    ...
    public static String REQUEST_URL_GONGLIN_TEST = "http://192.168.0.137:8060/";//龚林
    public static String REQUEST_URL_GONGLIN_FAHUO_TEST = "http://192.168.0.137:8030/";//龚林 测试 发货
