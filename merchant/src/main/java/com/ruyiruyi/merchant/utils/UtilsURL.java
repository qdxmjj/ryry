...
public class UtilsURL {
    public static final String LOGIN_PASS_REQUEST_URL_BIRD_SERVER = "http://192.168.0.60:8060/";//鸟
    ...
    public static String REQUEST_URL_GONGLIN_TEST = "http://192.168.0.122:8060/";//龚林
