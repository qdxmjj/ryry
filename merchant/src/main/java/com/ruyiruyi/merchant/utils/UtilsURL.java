...
public class UtilsURL {
    public static final String LOGIN_PASS_REQUEST_URL_BIRD_SERVER = "http://192.168.0.111:8060/";//电脑
    ...
    public static String REQUEST_URL_GONGLIN_TEST = "http://192.168.0.190:8060/";//龚林
    ...
    public static String REQUEST_URL_FAHUO = REQUEST_URL_GONGLIN_FAHUO_TEST;
